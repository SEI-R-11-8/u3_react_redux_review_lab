...
const locationSeed = async() => {
  const locations = [
    ...
    {
      name: 'Chattanooga',
      image: 'https://www.tnvacation.com/sites/default/files/article/CoolidgeParkHeroImage.jpg',
      description: 'Senic City',
      location: 'Tennessee',
  },
    {
      name: 'Times Square',
      image: 'https://media.istockphoto.com/photos/times-square-in-new-york-city-picture-id523513953',
